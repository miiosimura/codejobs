...
feature 'Headhunter list his job subscriptions' do
  scenario 'successfully' do
    ...
    other_job = Job.create!(headhunter_id: 1, title: 'Desenvolvedor Java', job_description: 'Descrição da vaga aqui', skills_description: 'Java', salary_min: 2000.0, salary_max: 3000.0, job_level: 'Senior', subscription_date: Date.today + 1.months, city: 'São Paulo', status: 'active')
